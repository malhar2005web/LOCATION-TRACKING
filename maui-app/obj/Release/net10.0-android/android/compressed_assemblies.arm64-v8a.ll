...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [146 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		i32 2071040, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 13842696; uint32_t buffer_offset
	}, ; 143: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22560, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 14014216; uint32_t buffer_offset
	}, ; 144: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2124288, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 14036776; uint32_t buffer_offset
	} ; 145: Mono.Android
], align 4

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 16161064, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [16161064 x i8] zeroinitializer, align 1
