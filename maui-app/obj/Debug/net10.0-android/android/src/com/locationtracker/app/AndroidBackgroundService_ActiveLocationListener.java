...
public class AndroidBackgroundService_ActiveLocationListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("LocationTracker.Platforms.Android.AndroidBackgroundService+ActiveLocationListener, LOCATION_TRACKING", AndroidBackgroundService_ActiveLocationListener.class, __md_methods);
	}

	public AndroidBackgroundService_ActiveLocationListener ()
	{
		super ();
		if (getClass () == AndroidBackgroundService_ActiveLocationListener.class) {
			mono.android.TypeManager.Activate ("LocationTracker.Platforms.Android.AndroidBackgroundService+ActiveLocationListener, LOCATION_TRACKING", "", this, new java.lang.Object[] {  });
		}
	}
